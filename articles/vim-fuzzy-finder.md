...
Vim,Neovimではファジーファインダー機能はデフォルトで入っておらず、なんらかのプラグインをインストールする必要があります。
...
| [fzf-preview.vim](https://github.com/yuki-ycino/fzf-preview.vim) | Neovim/Vim(coc.nvim利用時)       | TypeScript製リモートプラグイン or CocExtension                                                            | [![](https://img.shields.io/github/stars/yuki-ycino/fzf-preview.vim?label=%20&logo=%20)]() |
...
| [CocList](https://github.com/neoclide/coc-lists)                 | Vim/Neovimのcocユーザー          | coc.nvimに内包されている(coc.nvim自体はTypeScriptのリモートプラグイン(Vim側も自前で実装しているので動く)) | [![](https://img.shields.io/github/stars/neoclide/coc-lists?label=%20&logo=%20)]()         |
